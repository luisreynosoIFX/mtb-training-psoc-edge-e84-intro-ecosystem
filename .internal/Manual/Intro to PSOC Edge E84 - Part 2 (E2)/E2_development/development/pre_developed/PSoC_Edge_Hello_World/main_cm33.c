...
int main(void)
{
    ...
    /* Initialize LED */
    result = cyhal_gpio_init(TRAINING_LED, CYHAL_GPIO_DIR_OUTPUT,
	...
	printf("\x1b[2J\x1b[;H");
	    	  	 ...
	    	  	 printf("****************** "
	          	 "PSOC Edge MCU: Hello world using HAL "
	           	"****************** \r\n\n");
   ...
   "resume blinking the user LED \r\n\r\n");
	 ...
	 /* Enable CM55 */
	 Cy_SysEnableCM55(CY_CORTEX_M55_APPL_ADDR, CM55_BOOT_WAIT_TIME_USEC);
	 ...
	 for (;;)
	 {
		 ...
		 if (timer_interrupt_flag)
		 {
			 ...
			 cyhal_gpio_toggle(TRAINING_LED);
		 }
	 }
}
